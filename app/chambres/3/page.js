...
export default function Chambre3() {
  const chambre = workData[2]
  const details = {
    title: "Chambre 3 lumineuse",
    description: "Une chambre baignée de lumière naturelle pour 2 personnes",
    features: [
      "Lit double avec matelas premium",
      "Grande fenêtre orientée sud",
      "Espace de travail",
      "WiFi gratuit",
