...
export default function EtageComplet() {
  const chambre = workData[3]
  const details = {
    title: "Étage complet",
    description: "Un étage entier pour un groupe jusqu'à 7 personnes",
    features: [
      "3 chambres séparées",
      "2 salles de bain",
      "Salon commun",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                <h2 className="text-2xl font-bold mb-6">À propos de cet étage</h2>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-lg p-6 sticky top-8">
                <h3 className="text-xl font-bold mb-4">Réserver cet étage</h3>
